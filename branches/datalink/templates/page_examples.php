...
API documentation on individual endpoints can be found <a class='navigation_anchor' page='documentation' data='' href='/documentation'><u>Here</u></a>.
	...
	<nav class='example_nav'>
		...
		<a href='#example_bulk_write' class='example_nav_item'>Bulk Write</a>
		<a href='#example_datalink' class='example_nav_item'>Data link</a>
	...
	[[~example_section, {'example':'bulk_write','title':'Write up to 100 entities per request'} ]]
	
	[[~example_section, {'example':'datalink','title':'Store arbirtrary data attached to our models'} ]]
